  ...
  const renderAction = () => {
    return (
      <div>
        ...
        <EditFilled style={{ color: 'violet', fontSize: '30px', cursor: 'pointer' }} onClick={handleDetailsUser} />
      </div>
    )
  }
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '20px' }}>
        <TableComponent handleDelteMany={handleDelteManyUsers} titleButton="Export Excel" columns={columns} isLoading={isFetchingUser} data={dataTable} onRow={(record, rowIndex) => {
          return {
            onClick: event => {
