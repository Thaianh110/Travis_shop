...
const DetailsOrderPage = () => {
  ...
  return (
    <Loading isLoading={isLoading}>
      <div style={{ background: "#fff", paddingLeft: '20px' }}>
        <h3 style={{ margin: "10px" }}><span style={{ cursor: 'pointer', fontWeight: 'bold' }} onClick={() => { navigate('/') }}>Trang chủ</span> - Chi tiết đơn hàng</h3>
      </div>
      <div style={{  width: '100%', background: '#f5f5fa', paddingTop: '20px' }}>
