...
const MyOrderPage = () => {
  ...
  const handleCanceOrder = (order) => {
    if (!order.isDelivered) {
      ...
      alert("Đơn hàng đã giao. Không thể hủy!")
    }
  }
      ...
      <WrapperContainer>
        <div style={{ width: '100%', margin: '0 auto' }}>
          <div style={{ background: "#fff", paddingLeft: '20px' }}>
            <h3 style={{ margin: "10px" }}><span style={{ cursor: 'pointer', fontWeight: 'bold' }} onClick={() => { navigate('/') }}>Trang chủ</span> - Đơn hàng của tôi </h3>
          </div>
          <WrapperListOrder>
